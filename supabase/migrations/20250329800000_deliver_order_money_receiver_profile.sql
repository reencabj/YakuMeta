-- =============================================================================
-- Entrega: "quién recibió el dinero" = usuario existente en profiles (activo).
-- recibio_dinero_usuario_id pasa a ser quien recibió el efectivo; created_by sigue siendo quien registra la entrega.
-- =============================================================================
